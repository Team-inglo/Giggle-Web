...
const DocumentSubHeader = ({ type }: { type: DocumentType }) => {
  return (
    <div className="w-full relative flex flex-col items-center justify-center px-4 text-left">
      ...
      <div className="w-full max-w-[17.5rem] flex flex-col items-start justify-center gap-2">
        ...
        <div className="self-stretch relative justify-center body-2 text-primary-dark">
