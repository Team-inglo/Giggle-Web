  ...
  return (
    <div className="w-full flex flex-col">
      ...
      <div className="w-full flex flex-col gap-2">
        <div className="w-full relative rounded-lg bg-white border border-[#eae9f6] box-border h-11 flex flex-row items-center justify-center px-4 py-2.5 pl-4 text-left body-2 text-primary-dark">
